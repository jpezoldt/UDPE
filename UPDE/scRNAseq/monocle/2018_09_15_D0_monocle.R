...
plot_cell_clusters(cde_SC, 1, 2, color = "Cluster", markers = c("Vcam1")) #+ facet_wrap(~Time_point)
...
plot_cell_trajectory(cde_SC, markers = c("Cd34"), use_color_gradient = TRUE)
...
print(paste("Number of Adventi minus:", nrow(pData(Adventi_minus_stage))))
print(paste("Number of Adventi plus:", nrow(pData(Adventi_plus_stage))))
setwd(PATH_output)
...
saveRDS(cde_Adventi_minus_stage, file="~/NAS2/pezoldt/Analysis/scRNAseq/monocle/20180826_d0_Adventi_minus_stage.Rds")
