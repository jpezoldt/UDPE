...
saveRDS(mLN_Ontogeny_minus.merged, paste(PATH_Output,"/MultiAlign_20_1.6__D0_D10_D24_D56_D300.Rds", sep=""))
mLN_Ontogeny_minus.merged <- readRDS(paste(PATH_Output,"/MultiAlign_20_1.2__D0_D10_D24_D56_D300.Rds", sep=""))
#Change cluster ID
...
pdf(paste(PATH_Output,"/Dim20_Res1.2_NC_Top40_D0_D10_D24_D56_D300.pdf", sep=""))
...
#Save DEGs
write.table(mLN_Ontogeny_minus.merged.markers, paste(PATH_Output,"/Dim12_Res1.2_DEGs_D0_D10_D24_D56_D300.csv", sep=""), dec=".", sep=",")
mLN_Ontogeny_minus.merged.markers <- read.table(paste(PATH_Output,"/Dim20_Res1.2_DEGs_D0_D10_D24_D56_D300.csv", sep=""), dec=".", sep=",")
