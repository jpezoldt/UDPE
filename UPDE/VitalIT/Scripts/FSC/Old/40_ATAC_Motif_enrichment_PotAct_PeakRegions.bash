...
#BSUB -L /bin/bash
#BSUB -e /scratch/el/monthly/bdeplanc/pezoldt/Analysis/ATAC_FSC_all/ATAC_FSC_all_200.err
#BSUB -o /scratch/el/monthly/bdeplanc/pezoldt/Analysis/ATAC_FSC_all/ATAC_FSC_all_200.out
#BSUB -J Motif[1-4]
#BSUB -M 40000000
...
motifdir=$rootdir/Analysis/ATAC_FSC_all/homer/Motif_Input_R/Run_2/Act_reg/BED_peaks;
backgrounddir=$rootdir/Analysis/ATAC_FSC_all/homer/Motif_Input_R/Run_2/background_all_peaks_minus_input.bed;
resultdir=$rootdir/Analysis/ATAC_FSC_all/homer/Motif_Input_R/Run_2/Act_reg/Output_Regions;
...
findMotifsGenome.pl $motifdir/${name} mm10 $resultdir/$parameter${sample} -bg $backgrounddir -len 10
# -size 200
