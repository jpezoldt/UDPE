...
motifdir=$rootdir/Analysis/ATAC_FSC_all/homer/Motif_Input_R/BED_Peaks;
backgrounddir=$rootdir/Analysis/ATAC_FSC_all/homer/Motif_Input_R/background_genes.txt;
resultdir=$rootdir/Analysis/ATAC_FSC_all/homer/BED_Peaks;
preparseddir=$rootdir/Analysis/ATAC_FSC_all/homer/BED_Peaks;
