...
#extract count matrix
exprMat_Adventi <- sample_1_seurat_minus@raw.data[,Adventi_cells]
exprMat_nonAdventi <- sample_1_seurat_minus@raw.data[,nonAdventi_cells]
...
#####
#Load GRN boost
ex_5000SC_network <- read.delim("~/NAS2/pezoldt/Scripts/scRNAseq/scenic/GRNBoost_Output/ex_5000SC_network.tsv", header=FALSE)
#Note:
# Column #1 is the TFs
...
saveRDS(ex_5000SC_network, file="int/1.4_GENIE3_linkList.Rds")
