...
DARs_features_mLN_Commensal <- subset(DARs_features, abs(log2FC_mLN_SPF_GF) >= 1.0 & padj_mLN_SPF_GF <= 0.05)
...
DARs_features_pLN_Commensal <- subset(DARs_features, abs(log2FC_pLN_SPF_GF) >= 1.0 & padj_pLN_SPF_GF <= 0.05)
