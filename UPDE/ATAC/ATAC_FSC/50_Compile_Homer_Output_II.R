...
homerInDir <- '/home/pezoldt/NAS2/pezoldt/Analysis/ATACseq/ATAC_FSC_all/Motif/Homer_Output/allHomerResults/Output_Regions_BGreal_200bp'
setwd(homerInDir)
