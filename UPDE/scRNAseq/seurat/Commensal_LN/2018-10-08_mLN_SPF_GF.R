...
# Output_PATH
PATH_output <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq//seurat/LN_Commnesals/mLN"
...
#Experiment 2
sample_1_2.data <- Read10X(data.dir = "/home/pezoldt/NAS2/pezoldt/Data/scRNAseq/252_2017-07-19_scRNA-Seq_mLN_pLN_SPF_GF/Data/10x/mLN_SPF/B6/outs/filtered_gene_bc_matrices/mm10")
...
###
#Experiment 2 mLN GF
sample_2_2.data <- Read10X(data.dir = "/home/pezoldt/NAS2/pezoldt/Data/scRNAseq/269_2018-04-23_scRNA-Seq_mLN_GF/Data/E6_GF_mLN/outs/filtered_gene_bc_matrices/mm10")
...
new.cluster.ids <- c("Cd34+Gdf10+","Inmt+","Il6+Cxcl1+","Ccl19+Il7+",
                      "Cd34+Ackr3+","Cd34+Aldh1a2+","pSCx","Cd34+Cd248+",
                      "Madcam1+Ccl19+","PvC","PvC")
...
#write Table
t_DEG <- data.frame(matrix(ncol=6,nrow=0))
colnames(t_DEG) <- c("p_val","avg_logFC","pct.1","pct.2","p_val_adj","cluster_i")
...
genes_interest <- c("Aldh1a2", "Aldh1a3","Ptgis","Sfrp4","Bmper","Cd34","Tcf21")
