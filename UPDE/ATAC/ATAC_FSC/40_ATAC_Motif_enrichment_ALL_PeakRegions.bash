...
#BSUB -L /bin/bash
#BSUB -e /scratch/el/monthly/bdeplanc/pezoldt/Analysis/ATAC_FSC_all/std_err_out/ATAC_FSC_all_600.err
#BSUB -o /scratch/el/monthly/bdeplanc/pezoldt/Analysis/ATAC_FSC_all/std_err_out/ATAC_FSC_all_600.out
#BSUB -J Motif[1-8]
#BSUB -M 40000000
...
findMotifsGenome.pl $motifdir/${name} mm10 $resultdir/$parameter${sample} -bg $backgrounddir -size given -len 10
#$parameter
