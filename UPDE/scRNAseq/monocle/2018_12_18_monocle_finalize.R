...
for(i in 1:length(datasets)){
  ...
  cells_include_i <- readRDS(paste(PATH_Output,"/",dataset_time_point_i,"_1500_1000_1_12_cells_include_all.Rds", sep=""))
  #Row index
...
plot_cell_trajectory(cde_SC, color_by = "State", markers = c("Cdk1"), use_color_gradient = TRUE)  + facet_wrap(~Time_point)
...
#Save RDS
saveRDS(cde_SC, file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_all.Rds",sep=""))
#cde_SC <- readRDS(file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include.Rds",sep=""))
