...
day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_minus_feeder2 <-
  readRDS("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/monocle/day0_10_24_56_300/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_minus_feeder2.Rds")
...
cde_x <- day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_minus_feeder2
...
nrow(subset(pData(cde_x), State == 4))
...
plot_cell_trajectory(cde_NonAdv, color_by = "State") + facet_wrap(~Cluster_Seurat)
...
plot_cell_trajectory(cde_NonAdv, markers = c("Bst1","Pdpn","Pdgfrb","Cd34","Il6","Cxcl1"), use_color_gradient = TRUE, cell_size = 0.5)
...
plot_cell_trajectory(cde_Adv, color_by = "State") + facet_wrap(~Cluster_Seurat)
...
plot_genes_branched_heatmap(cde_x[row.names(subset(l_BEAM_res[[2]],qval < 5*1e-25)),],
                            branch_point = 2,
                            #branch_states = c(1,5),
                            ...
                            show_rownames = T,
                            branch_colors = c("white", "blue", "red"))
#All Branch defining genes
Branch_1 <- subset(l_BEAM_res[[1]],qval < 5*1e-2)
Branch_2 <- subset(l_BEAM_res[[2]],qval < 5*1e-2)
Branches <- rbind(Branch_1, Branch_2)
DAR_TFs <- rownames(DAR_existence_matrix)
#Get TFs that are branching and identified from DARs
TFs_Branching_from_DARs <- unique(subset(Branches, gene_short_name %in% DAR_TFs)$id)
...
saveRDS(l_BEAM_res, paste(PATH_output,"/","BEAM_day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_2_3_PvC_only_NonAdventi.rds",sep=""))
