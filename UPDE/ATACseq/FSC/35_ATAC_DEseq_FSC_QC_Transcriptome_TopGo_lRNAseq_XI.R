...
path_output_GO_DEG <- "/home/pezoldt/NAS2/pezoldt/Analysis/01_Integrated/DARs_DEGs/GO"
...
List_GOs_interest <- unlist(lapply(strsplit(rownames(data_heatmap_zoom), "_"), function(x) {x[[1]]}))
Names_GOs_interest <- unlist(lapply(strsplit(rownames(data_heatmap_zoom), "_"), function(x) {x[[2]]}))
#Selected GOs
#List_GOs_interest <- c("GO:0006955","GO:0019233","GO:0030198","GO:0030593",
 #                      "GO:0034097","GO:0034612","GO:0042127","GO:0042742",
  #                     "GO:0048535","GO:1901223")

#Generate named vector to access name of GO by ID
names(Names_GOs_interest) <- List_GOs_interest
...
for(i in 1:number_input){
  ...
  if(number_genes_expressed_in_GO >= 4){
    ...
    #make meaned table
    data_heatmap_matrix <- as.matrix(cbind(mLN_GF, pLN_GF, mLN_SPF, pLN_SPF))
