...
#Mac
setwd("/Users/Pezoldt/PowerFolders/R/2016_Stroma_LI/210_Complete_Expression_only")
#Windows
...
# Rational:
#2) DEGs that are also DARs are potentially addressed by Regulons (TF->>>> genes)
#   get +/+ and -/-
#SPF
...
hist(ActReg_features_TSS_i_bed_i$end - ActReg_features_TSS_i_bed_i$start, freq = NULL)
