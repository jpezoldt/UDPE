...
#BSUB -L /bin/bash
#BSUB -e /scratch/el/monthly/bdeplanc/pezoldt/Analysis/ATAC_FSC_all/ATAC_FSC_all_NoDAR.err
#BSUB -o /scratch/el/monthly/bdeplanc/pezoldt/Analysis/ATAC_FSC_all/ATAC_FSC_all_NoDAR.out
#BSUB -J Motif[1-4]
#BSUB -M 40000000
...
motifdir=$rootdir/Analysis/ATAC_FSC_all/homer/Motif_Input_R/Run_2/TF_reg/GeneNames;
