...
#####
#PATH
PATH_Output <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/2019_DiSCO_Organoid/seurat"
#Signatures from 2017, Haber
Signature_Haber_2017_HighConf <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/2019_DiSCO_Organoid/External_Input/2019-01-08_Intestinal_Organoid_signatures_Haber_2017_HighConf.txt")
Signature_Haber_2017_Droplet <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/2019_DiSCO_Organoid/External_Input/2019-01-08_Intestinal_Organoid_signatures_Haber_2017_Droplet.txt")
#Signature from 2015, Gruen
Signature_Haber_2015_HighConf <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/2019_DiSCO_Organoid/External_Input/2019-01-08_Intestinal_Organoid_signatures_Gruen_2015.txt")
#Cell cycle genes
...
###
#Sample 1
sample_1_1.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d2_01_merge.txt")
colnames(sample_1_1.data) <- paste(sample_1,"_1_", c(1:ncol(sample_1_1.data)), sep = "")
#Sample 2
sample_1_2.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d2_021_merge.txt")
colnames(sample_1_2.data) <- paste(sample_1,"_2_", c((ncol(sample_1_1.data)+1):(ncol(sample_1_1.data)+ncol(sample_1_2.data))), sep = "")
#Sample 3
sample_1_3.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d2_022_merge.txt")
colnames(sample_1_3.data) <- paste(sample_1,"_2_", c((ncol(sample_1_1.data)+ncol(sample_1_2.data)+1):(ncol(sample_1_1.data)+ncol(sample_1_2.data)+ncol(sample_1_3.data))), sep = "")

###
#Organoid d3
###
sample_2_1.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d3_01_merge.txt")
colnames(sample_2_1.data) <- paste(sample_2,"_1_", c(1:ncol(sample_2_1.data)), sep = "")
#Sample 2
sample_2_2.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d3_02_merge.txt")
colnames(sample_2_2.data) <- paste(sample_2,"_2_", c((ncol(sample_2_1.data)+1):(ncol(sample_2_1.data)+ncol(sample_2_2.data))), sep = "")
#Sample 3
sample_2_3.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d3_03_merge.txt")
colnames(sample_2_3.data) <- paste(sample_2,"_3_", c((ncol(sample_2_1.data)+ncol(sample_2_2.data)+1):(ncol(sample_2_1.data)+ncol(sample_2_2.data)+ncol(sample_2_3.data))), sep = "")

###
#Organoid d5
###
sample_3_1.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d5_01_merge.txt")
colnames(sample_3_1.data) <- paste(sample_3,"_1_", c(1:ncol(sample_3_1.data)), sep = "")
#Sample 2
sample_3_2.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d5_02_merge.txt")
colnames(sample_3_2.data) <- paste(sample_3,"_2_", c((ncol(sample_3_1.data)+1):(ncol(sample_3_1.data)+ncol(sample_3_2.data))), sep = "")
#
###
#Organoid d6
###
sample_4_1.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d6_01_merge.txt")
colnames(sample_4_1.data) <- paste(sample_4,"_1_", c(1:ncol(sample_4_1.data)), sep = "")
#Sample 2
sample_4_2.data <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/PostProcessed/Merge/d6_02_merge.txt")
colnames(sample_4_2.data) <- paste(sample_4,"_2_", c((ncol(sample_4_1.data)+1):(ncol(sample_4_1.data)+ncol(sample_4_2.data))), sep = "")


# Convert to sparse matrices for efficiency
sample_1_1.data <- as(as.matrix(sample_1_1.data), "dgCMatrix")
sample_1_2.data <- as(as.matrix(sample_1_2.data), "dgCMatrix")
sample_1_3.data <- as(as.matrix(sample_1_3.data), "dgCMatrix")

sample_2_1.data <- as(as.matrix(sample_2_1.data), "dgCMatrix")
sample_2_2.data <- as(as.matrix(sample_2_2.data), "dgCMatrix")
sample_2_3.data <- as(as.matrix(sample_2_3.data), "dgCMatrix")

sample_3_1.data <- as(as.matrix(sample_3_1.data), "dgCMatrix")
sample_3_2.data <- as(as.matrix(sample_3_2.data), "dgCMatrix")
...
sample_1_3_seurat <- CreateSeuratObject(raw.data = sample_1_3.data, min.cells = min_cells, min.genes = min_gene_number)
sample_1_seurat <- MergeSeurat(sample_1_1_seurat, sample_1_2_seurat, do.normalize = FALSE)
sample_1_seurat <- MergeSeurat(sample_1_seurat, sample_1_3_seurat, do.normalize = FALSE)
sample_1_seurat <- NormalizeData(sample_1_seurat)
sample_1_seurat <- FindVariableGenes(sample_1_seurat, do.plot = T, display.progress = F)
...
sample_2_3_seurat <- CreateSeuratObject(raw.data = sample_2_3.data, min.cells = min_cells, min.genes = min_gene_number)
sample_2_seurat <- MergeSeurat(sample_2_1_seurat, sample_2_2_seurat, do.normalize = FALSE)
sample_2_seurat <- MergeSeurat(sample_2_seurat, sample_2_3_seurat, do.normalize = FALSE)
sample_2_seurat <- NormalizeData(sample_2_seurat)
sample_2_seurat <- FindVariableGenes(sample_2_seurat, do.plot = T, display.progress = F)
sample_2_seurat <- ScaleData(sample_2_seurat)
sample_2_seurat@meta.data$tech <- sample_2

#sample_3
sample_3_1_seurat <- CreateSeuratObject(raw.data = sample_3_1.data, min.cells = min_cells, min.genes = min_gene_number)
sample_3_2_seurat <- CreateSeuratObject(raw.data = sample_3_2.data, min.cells = min_cells, min.genes = min_gene_number)
sample_3_seurat <- MergeSeurat(sample_3_1_seurat, sample_3_2_seurat, do.normalize = FALSE)
sample_3_seurat <- NormalizeData(sample_3_seurat)
sample_3_seurat <- FindVariableGenes(sample_3_seurat, do.plot = T, display.progress = F)
...
sample_4_seurat <- FindVariableGenes(sample_4_seurat, do.plot = T, display.progress = F)
...
organoid.merged <- MergeSeurat(sample_1_seurat, sample_2_seurat, do.normalize = FALSE)
organoid.merged <- MergeSeurat(organoid.merged, sample_3_seurat, do.normalize = FALSE)
organoid.merged <- MergeSeurat(organoid.merged, sample_4_seurat, do.normalize = FALSE)
organoid.merged <- NormalizeData(organoid.merged)
organoid.merged <- FindVariableGenes(organoid.merged, do.plot = T, display.progress = F)
organoid.merged <- ScaleData(organoid.merged)
...
#Score each cell
cell_cycle_data <- CellCycleScoring(object = organoid.merged, s.genes = s.genes, g2m.genes = g2m.genes, 
                                    set.ident = TRUE)
cell_cycle_Sscore <- cell_cycle_data@meta.data$S.Score
cell_cycle_G2Mscore <- cell_cycle_data@meta.data$G2M.Score
cell_cycle_Phase <- as.character(cell_cycle_data@meta.data$Phase)
organoid.merged@meta.data$Sscore <- cell_cycle_Sscore
organoid.merged@meta.data$G2Mscore <- cell_cycle_G2Mscore
organoid.merged@meta.data$Phase <- cell_cycle_Phase

#Mito genes
mito.genes <- grep(pattern = "^mt-", x = rownames(organoid.merged@data), value = TRUE)
percent.mito <- colSums(as.matrix(organoid.merged@raw.data[mito.genes, ]))/colSums(as.matrix(organoid.merged@raw.data))

#Identify cells with high rpl reads
rpl.genes <- grep(pattern = "^Rpl", x = rownames(organoid.merged@data), value = TRUE)
percent.rpl <- colSums(as.matrix(organoid.merged@raw.data[rpl.genes, ]))/colSums(as.matrix(organoid.merged@raw.data))

#Identify cells with low nGene/nUmi ratio
ratio.nUMITOnGene <- organoid.merged@meta.data$nUMI / organoid.merged@meta.data$nGene
names(ratio.nUMITOnGene) <- rownames(organoid.merged@meta.data)



# AddMetaData adds columns to object@data.info and good to store QC stats
organoid.merged <- AddMetaData(object = organoid.merged, metadata = percent.mito, col.name = "percent.mito")
organoid.merged <- AddMetaData(object = organoid.merged, metadata = ratio.nUMITOnGene, col.name = "ratio.nUMITOnGene")
organoid.merged <- AddMetaData(object = organoid.merged, metadata = percent.rpl, col.name = "percent.rpl")

#QC plots
par(mfrow = c(1, 2))
GenePlot(object = organoid.merged, gene1 = "nUMI", gene2 = "percent.mito")
GenePlot(object = organoid.merged, gene1 = "nUMI", gene2 = "nGene")
VlnPlot(object = organoid.merged, features.plot = c("nGene", "nUMI", "percent.mito","ratio.nUMITOnGene","percent.rpl"), nCol = 5)
...
print(paste("Number of cells before filtering:",nrow(organoid.merged@meta.data)))
organoid.merged_filter <- FilterCells(object = organoid.merged, subset.names = c("nGene", "nUMI", "percent.mito"), 
                                             low.thresholds = c(min_gene_number, -Inf, -Inf), high.thresholds = c(nGene, 50000, mito_cutoff))
print(paste("Number of cells after filtering:",nrow(organoid.merged_filter@meta.data)))
organoid.merged_filter <- NormalizeData(organoid.merged_filter)
organoid.merged_filter <- FindVariableGenes(organoid.merged_filter, do.plot = T, display.progress = F)
organoid.merged_filter <- ScaleData(object = organoid.merged_filter, vars.to.regress = c("Sscore", "G2Mscore","nGene", "percent.mito"), 
                                    display.progress = FALSE)
#Run PCA
organoid.merged_filter <- RunPCA(object = organoid.merged_filter, pc.genes = organoid.merged_filter@var.genes, do.print = TRUE, pcs.print = 1:10, 
                          genes.print = 10)

# Examine and visualize PCA results
PrintPCA(object = organoid.merged_filter, pcs.print = 1:5, genes.print = 5, use.full = FALSE)
VizPCA(object = organoid.merged_filter, pcs.use = 1:6)
PCAPlot(object = organoid.merged_filter, dim.1 = 1, dim.2 = 2)
...
for (i in 1:length(ob.list)) {
  genes.use <- c(genes.use, head(rownames(ob.list[[i]]@hvg.info), 1500))
}
...
saveRDS(ob.list, paste(PATH_Output,"/obs.list.Rds", sep=""))

# Run multi-set CCA
organoid.merged_filter <- RunMultiCCA(ob.list, genes.use = genes.use, num.ccs = dims_use)

# CC Selection
#MetageneBicorPlot(organoid.merged_filter, grouping.var = "tech", dims.eval = 1:dims_use)

# Run rare non-overlapping filtering
organoid.merged_filter <- CalcVarExpRatio(object = organoid.merged_filter, reduction.type = "pca",
                                           grouping.var = "tech", dims.use = 1:dims_use)
organoid.merged_filter <- SubsetData(organoid.merged_filter, subset.name = "var.ratio.pca",
                                      accept.low = 0.5)

# Alignment
organoid.merged_filter <- AlignSubspace(organoid.merged_filter,
                                         reduction.type = "cca",
                                         grouping.var = "tech",
                                         dims.align = 1:dims_use)

#Plot the aligned CCA ACCA
p1 <- VlnPlot(organoid.merged_filter, features.plot = "ACC1", group.by = "tech", do.return = T)
p2 <- VlnPlot(organoid.merged_filter, features.plot = "ACC2", group.by = "tech", do.return = T)
plot_grid(p1, p2)

# t-SNE and Clustering
organoid.merged_filter <- RunTSNE(organoid.merged_filter,
                                   reduction.use = "cca",
                                   dims.use = 1:dims_use, save.SNN = T,
                                   resolution = resolution_merge, force.recalc = TRUE)
organoid.merged_filter <- FindClusters(organoid.merged_filter, reduction.type = "cca",
                                dims.use = 1:dims_use, save.SNN = T, resolution = 0.9,
                                force.recalc = TRUE)

#Change cluster ID
current.cluster.ids <- c("Lgr5highOlfm4+","TA","Enterocyte1","Enterocyte2",
                         "preEnterocyte","lateEnterocyte","Lgr5medOlfm4+","Secretory")

new.cluster.ids <- c("Lgr5+Olfm4+","TA","Enterocyte1","Enterocyte2",
                     "preEnterocyte","late_preEnterocyte","TA2","Secretory")

organoid.merged_filter@ident <- plyr::mapvalues(x = organoid.merged_filter@ident, from = current.cluster.ids, to = new.cluster.ids)
organoid.merged_filter@meta.data$Cluster <- organoid.merged_filter@ident


#Add dataset distinguishing number to metadata
sample_categorizer <- unlist(lapply(strsplit(rownames(organoid.merged_filter@meta.data), "_"), function(x){paste(x[[1]],x[[2]],sep="_")}))
organoid.merged_filter@meta.data$sample_categorizer <- sample_categorizer
v_samples <- levels(as.factor(sample_categorizer))
#Add Sample score to metadata
Sample_score <- list()
for(i in 1:length(v_samples)){
  Sample_i <- v_samples[i]
  binary_i <- apply(organoid.merged_filter@meta.data, 1, function(r) any(r %in% c(Sample_i)))
...
meta_data_temp <- cbind(organoid.merged_filter@meta.data, Sample_score)
organoid.merged_filter@meta.data <- meta_data_temp
#Age plotting and store in list
plot_store <- list()
par(mfrow = c(4, ceiling(length(v_samples)/4)))
for(i in 1:length(v_samples)){
  sample_i <- v_samples[i]
  p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                                 nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
  plot_store[[i]] <- p_i
}
plot_grid(plot_store[[1]],plot_store[[2]],plot_store[[3]])
d2_1 <- FeaturePlot(organoid.merged_filter, features.plot = c("d2_1"), 
           nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
...
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[2]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[3]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[4]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[5]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[6]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[7]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[8]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[9]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)
sample_i <- v_samples[10]
p_i <- FeaturePlot(organoid.merged_filter, features.plot = sample_i, 
                   nCol = 1, cols.use = c("lightgrey", "black"), pt.size = 0.5)

#Check allocation of cells
sample_1_cells <- grep(pattern = "^d2", x = rownames(organoid.merged_filter@meta.data), value = TRUE)
sample_2_cells <- grep(pattern = "^d3", x = rownames(organoid.merged_filter@meta.data), value = TRUE)
sample_3_cells <- grep(pattern = "^d5", x = rownames(organoid.merged_filter@meta.data), value = TRUE)
sample_4_cells <- grep(pattern = "^d6", x = rownames(organoid.merged_filter@meta.data), value = TRUE)
p1 <- TSNEPlot(organoid.merged_filter, group.by = "tech", do.return = T, pt.size = 0.4, cells.use = sample_1_cells)
p2 <- TSNEPlot(organoid.merged_filter, group.by = "tech", do.return = T, pt.size = 0.4, cells.use = sample_2_cells)
p3 <- TSNEPlot(organoid.merged_filter, group.by = "tech", do.return = T, pt.size = 0.4, cells.use = sample_3_cells)
p4 <- TSNEPlot(organoid.merged_filter, group.by = "tech", do.return = T, pt.size = 0.4, cells.use = sample_4_cells)
p5 <- TSNEPlot(organoid.merged_filter, do.return = T, pt.size = 0.4, do.label = TRUE)

p6 <- TSNEPlot(organoid.merged_filter, group.by = "tech", do.return = T, pt.size = 0.4,
              colors.use = c("orange","green","blue","purple"))
par(mfrow = c(3, 2))
plot_grid(p1, p2, p3, p4, p5, p6)
plot_grid(p5)

FeaturePlot(organoid.merged_filter, features.plot = c("Lgr5","Alpi","Chga","Muc2","Lyz1","Olfm4"),
          min.cutoff = "q9",
            cols.use = c('lightgrey', 'brown'),
            pt.size = 0.6)

FeaturePlot(organoid.merged_filter, features.plot = c("Jun","Jund","Sox9","Id2","Ephb1"),
            min.cutoff = "q9",
            cols.use = c('lightgrey', 'brown'),
            pt.size = 0.6)

FeaturePlot(organoid.merged_filter, features.plot = c("St3gal4","Mgst3","Lgals2","Lgals4"),
            min.cutoff = "q9",
            cols.use = c('lightgrey', 'brown'),
            pt.size = 0.6)

saveRDS(organoid.merged_filter, paste(PATH_Output,"/MultiAlign_12_1500_1_regressed_1000genesPerCell.Rds", sep=""))

organoid.merged_filter <- readRDS(paste(PATH_Output,"/MultiAlign_14_1500_1_regressed.Rds", sep=""))


#####
#Cluster identification via signature, Haber 2017, Gruen 2015
#####
#Haber, process list
Signature_Haber <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/Signatures/2019-01-08_Intestinal_Organoid_signatures_Haber_2017_HighConf.txt")
l_Signature_Haber <- list()
for(i in 1:ncol(Signature_Haber)){
  cell_type_i <- levels(Signature_Haber[,i])
  cell_type_i <- unique(cell_type_i[cell_type_i != ""]) 
  #print(cell_type_i)
  l_Signature_Haber[[i]] <- cell_type_i
}
names(l_Signature_Haber) <- colnames(Signature_Haber)

#Gruen, process List
Signature_Gruen <- read.delim("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/2019_Organoids/Signatures/2019-01-08_Intestinal_Organoid_signatures_Gruen_2015.txt")
l_Signature_Gruen <- list()
for(i in 1:ncol(Signature_Gruen)){
  cell_type_i <- levels(Signature_Gruen[,i])
  cell_type_i <- unique(cell_type_i[cell_type_i != ""]) 
  cell_type_i <- unlist(lapply(strsplit(cell_type_i, "__"), function(x){x[[1]]}))
  #print(cell_type_i)
  l_Signature_Gruen[[i]] <- cell_type_i
}
names(l_Signature_Gruen) <- colnames(Signature_Gruen)

#Signature of choice
Name <- "Gruen2015"
DEGs_list <- l_Signature_Gruen


#Average gene expression 
aExp_organoid.merged <- AverageExpression(organoid.merged_filter)
...
for(i in i:length(DEGs_list)){
  cluster_DEG_i <- as.character(DEGs_list[[i]])
  ...
  aExp_organoid.merged_i <- subset(aExp_organoid.merged, rownames(aExp_organoid.merged) %in% cluster_DEG_i)
  
  Scale_aExp_organoid.merged_i <- apply(aExp_organoid.merged_i, 1, scale)
  Zscore_cluster_i <- rowSums(Scale_aExp_organoid.merged_i)
  Zscore_cluster_i_norm <- Zscore_cluster_i / (nrow(aExp_organoid.merged_i)/10)
  
  #mLN maintained Scores
  Zscore_table_cluster_i <- data.frame(module = c(rep(cluster_ID_i,length(Zscore_cluster_i_norm))),
                                       cluster = colnames(aExp_organoid.merged),
...
title <- paste("Organoid_Signature",Name,sep = "_")
pdf(paste(PATH_Output,"/",Name,"_Signature_TopDEGs_minus_d2_d3_outlier.pdf", sep=""))
marrangeGrob(out, nrow = 3, ncol = 3, top = title)
dev.off()
...
organoid.merged_filter.markers <- FindAllMarkers(object = organoid.merged_filter, only.pos = TRUE, min.pct = 0.25, 
                                                    thresh.use = 0.25)
organoid.merged_filter.markers_20 <- organoid.merged_filter.markers %>% group_by(cluster) %>% top_n(20, avg_logFC)
organoid.merged_filter.markers_40 <- organoid.merged_filter.markers %>% group_by(cluster) %>% top_n(40, avg_logFC)
organoid.merged_filter.markers_20 <- organoid.merged_filter.markers_20$gene
#Order LN_minus meta.data according to cluster size

#Save DEGs
write.table(organoid.merged_filter.markers, paste(PATH_Output,"/Markers_MultiAlign_12_1500_1_regressed.csv", sep=""), dec=".", sep=",")
organoid.merged_filter.markers <- read.table(paste(PATH_Output,"/Markers_MultiAlign_12_1500_1_regressed.csv", sep=""), dec=".", sep=",")
...
DoHeatmap(object = organoid.merged_filter, use.scaled = TRUE, group.by = "ident",
          genes.use = organoid.merged_filter.markers_20, title = "Merged FSC Ontogeny",
          remove.key = FALSE,
          col.low = "white",
          col.mid =  "oldlace",
          col.high = "brown")
...
organoid.merged_filter.markers_nonDup <- organoid.merged_filter.markers[!duplicated(organoid.merged_filter.markers$gene),]
organoid.merged_filter.markers_nonDup_10_pValue <- organoid.merged_filter.markers_nonDup %>% group_by(cluster) %>% top_n(10, 1/p_val_adj)
organoid.merged_filter.markers_nonDup_20_pValue <- organoid.merged_filter.markers_nonDup %>% group_by(cluster) %>% top_n(20, 1/p_val_adj)
organoid.merged_filter.markers_nonDup_10_FC <- organoid.merged_filter.markers_nonDup %>% group_by(cluster) %>% top_n(8, avg_logFC)
organoid.merged_filter.markers_nonDup_20_FC <- organoid.merged_filter.markers_nonDup %>% group_by(cluster) %>% top_n(20, avg_logFC)

#Plot differential expression of Marker genes
title <- "Dotplot"
#pdf(paste(path_output,"/",title, ".pdf", sep = ""), width = 25, height = 10)
DotPlot(organoid.merged_filter, organoid.merged_filter.markers_nonDup_10_FC$gene,
...
unique_clusters <- c()
All_meta <- subset(organoid.merged_filter@meta.data)
number_of_cells = 0
for(i in 1:length(v_sample)){
  ...
  saveRDS(cells_include_i, paste(PATH_Output,"/",v_sample_i,"_MultiAlign_12_1500_1_regressed.Rds", sep=""))
}
print(number_of_cells)
#Write Metadata
saveRDS(All_meta, paste(PATH_Output,"/","MetaData_MultiAlign_12_1500_1_regressed.Rds", sep=""))
...
#####
#Average expression
aExp_organoid.merged_filter <- AverageExpression(organoid.merged_filter)
#Check for DEGs
#genes <- as.character(LN_minus.markers_20[1:260,]$gene)
aExp_organoid.merged_filter_TopDEGs <- subset(aExp_organoid.merged_filter, rownames(aExp_organoid.merged_filter) %in% organoid.merged_filter.markers_20$gene)
aExp_organoid.merged_filter_TopDEGs <- as.matrix(aExp_organoid.merged_filter_TopDEGs)

title <- paste("Heatmap_hierarchical",sep = "_")
#pdf(paste(path_output,"/",title, ".pdf", sep = ""), width = 6, height = 7)
pheatmap(aExp_organoid.merged_filter_TopDEGs, cluster_rows = TRUE, legend = TRUE,
...
#####
meta_data <- organoid.merged_filter@meta.data
l_condition <- split(meta_data, meta_data$sample_categorizer)
...
pheatmap(freq_cells_per_condition, cluster_rows = FALSE, legend = TRUE,
...
#####
#Calculate % per cluster across sample
#####
meta_data <- organoid.merged_filter@meta.data
l_condition <- split(meta_data, meta_data$sample_categorizer)
l_cells_per_condition <- lapply(l_condition, function(x) {
...
names(l_cells_per_condition) <- names(l_condition)
t_cells_per_condition <- do.call(cbind, lapply(l_cells_per_condition, function(x) {as.data.frame(x)}))
t_cells_per_condition[is.na(t_cells_per_condition)] <- 0
colnames(t_cells_per_condition) <- names(l_condition)
#Total Number of cells
total_number_vector <- colSums(t_cells_per_condition)
#Divide cell number per cluster by normalization factor
t_cells_per_condition_norm <- t_cells_per_condition / total_number_vector * 100
#Calculate Frequencies
total <- colSums(t_cells_per_condition_norm)
freq_cells_per_condition <- round((t(t_cells_per_condition_norm) / total) * 100)
freq_cells_per_condition <- as.matrix(freq_cells_per_condition)
pheatmap(freq_cells_per_condition, cluster_rows = FALSE, legend = TRUE,
         treeheight_row = 0, treeheight_col = 0, show_rownames = TRUE, cluster_cols = FALSE,
         scale = "none", border_color = "black", cellwidth = 10,
...
#####
#Find markers for every cluster compared to all remaining cells
mLN_Ontogeny_minus.merged.markers <- FindAllMarkers(object = obs.mLN_Ontogeny_Cdk1.merged, only.pos = TRUE, min.pct = 0.25, 
                                                    thresh.use = 0.25)
mLN_Ontogeny_minus.merged.markers_20 <- mLN_Ontogeny_minus.merged.markers %>% group_by(cluster) %>% top_n(20, avg_logFC)
mLN_Ontogeny_minus.merged.markers_40 <- mLN_Ontogeny_minus.merged.markers %>% group_by(cluster) %>% top_n(40, avg_logFC)
