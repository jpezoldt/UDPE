...
print("Endothelial cell identification Done")
...
#Save R object
#####
saveRDS(cde_SC, file="~/NAS2/pezoldt/Analysis/scRNAseq/monocle/20180813_monocle_ontogeny.Rds") 
cde_SC <- readRDS(file="~/NAS2/pezoldt/Analysis/scRNAseq/monocle/20180813_monocle_ontogeny_mLNGFdeg.Rds")
