...
#macs2 callpeak -t $resultdir/aligned/${sample}/${sample}.nodup.bam -f BAM -n ${sample}_default --outdir $resultdir/peaks/default/${sample} -g hs -q 0.05
#macs2 callpeak -t $resultdir/aligned/${sample}/${sample}.nodup.bam -f BAMPE -n ${sample}_PE --outdir $resultdir/peaks/paired-end/${sample} -g hs -q 0.05
#macs2 callpeak -t $resultdir/aligned/${sample}/${sample}.nodup.bam -f BAM --broad -n ${sample}_broad --outdir $resultdir/peaks/broad/${sample} -g hs -q 0.05
#macs2 callpeak -t $resultdir/aligned/${sample}/${sample}.nodup.bam -f BAM --nolambda -n ${sample}_nolambda --outdir $resultdir/peaks/nolambda/${sample} -g hs -q 0.05
#macs2 callpeak -t $resultdir/aligned/${sample}/${sample}.nodup.bam -f BAM -n ${sample}_ext73 --outdir $resultdir/peaks/ext73/${sample} --extsize 73 -g hs -q 0.05 
#macs2 callpeak -t $resultdir/aligned/${sample}/${sample}.nodup.bam -f BAM -n ${sample}_ext150 --outdir $resultdir/peaks/ext150/${sample} --extsize 150 -g hs -q 0.05 

#mkdir -p $resultdir/peaks/broad${sample}_bl;

#8. Remove blacklisted regions from peak calling
#intersectBed -v -a $resultdir/peaks/broad/${sample}/${sample}_broad_peaks.bed -b $blacklist > $resultdir/peaks/broad/${sample}_bl/${sample}_broad_peaks_bl.bed

#9. Summarize peak calling
#.jar script runs thorugh directories and agglomerates MACS, Alignement... data
#java -jar $rootdir/Scripts/SummarizeAlignments.jar $resultdir/peaks/default/${sample}
#java -jar $rootdir/Scripts/SummarizeAlignments.jar $resultdir/peaks/paired-end/${sample}
#java -jar $rootdir/Scripts/SummarizeAlignments.jar $resultdir/peaks/broad/${sample}
#java -jar $rootdir/Scripts/SummarizeAlignments.jar $resultdir/peaks/nolambda/${sample}
#java -jar $rootdir/Scripts/SummarizeAlignments.jar $resultdir/peaks/ext73/${sample}
#java -jar $rootdir/Scripts/SummarizeAlignments.jar $resultdir/peaks/ext150/${sample}

#10. Enrichment plot --> atac_enrichment.sh

#11. Peak quantification 
#!!!not running smoothly
#makeTagDirectory $resultdir/aligned/$sample/tags $resultdir/aligned/${sample}/${sample}.nodup.bam
#makeTagDirectory $resultdir/aligned/ATAC_mLNSPF2/tags $resultdir/aligned/ATAC_mLNSPF2/ATAC_mLNSPF2.nodup.bam

annotatePeaks.pl $resultdir/peaks/broad/Overlap_Merged/Run_3_Outlier_excluded/ATAC_FSC_all_broad_merged_peaks.bed mm10 -size given -noadj -organism mouse -d $resultdir/aligned/$sample/tags > $resultdir/homer/Overlap_Group_Merged/Run_3_Outlier_excluded/${sample}.txt
