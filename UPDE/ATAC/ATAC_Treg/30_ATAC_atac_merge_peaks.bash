...
cat $resultdir/$method/Overlap_Merged/Run_2_Across_All_Replicates/*.bed | sort -k 1,1 -k2,2n > $resultdir/$method/Overlap_Merged/Run_3_Outlier_excluded/ATAC_FSC_all_${method}_concat_peaks.bed
...
bedtools merge -i $resultdir/$method/Overlap_Merged/Run_2_Across_All_Replicates/ATAC_FSC_all_${method}_concat_peaks.bed > $resultdir/$method/Overlap_Merged/Run_3_Outlier_excluded/ATAC_FSC_all_${method}_merged_peaks.bed
