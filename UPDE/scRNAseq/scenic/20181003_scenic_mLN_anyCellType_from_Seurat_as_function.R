...
#Load Seurat Objects
#####
PATH_seurat <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/Subsets_to_scenic/mLN_D0/mLN_D0.Rds"
...
clusters_of_interest <- c("CD34+Ackr3+","Il6+Cxcl1+","CD34+Gdf10+","Ccl19+Madcam1+","CD34+Aldh1a2")
...
makeSCEfromSEURAT <- function(PATH_seurat, clusters_of_interest){
  ...
  #Save color code for cells obtained from seurat
