...
#Function: Align to scRNAseq datasets
# 1) Subset selection
# 2) DEG across cluster
# 3) GO analysis
# 4) DEG within cluster across samples
# 5) Zscore signature
...
#mLN-SPF Tx
###
sample_1.data <- Read10X(data.dir = "/home/pezoldt/NAS2/pezoldt/Data/scRNAseq/244_scRNA-Seq_mLN_pLN_SPF/Data/10X_results/L1700566_pLN_SPF/filtered_gene_bc_matrices/mm10")
sample_1.data@Dimnames[[2]] <- paste("sample_1_", c(1:length(sample_1.data@Dimnames[[2]])), sep = "")

###
#pLN-SPF Tx
###
sample_2.data <- Read10X(data.dir = "/home/pezoldt/NAS2/pezoldt/Data/scRNAseq/268_2018-01-03_scRNA-Seq_Tx_mLN_GF_SPF_popLN_SPF/Data/10x/D2_Tx_mLN_SPF/outs/filtered_gene_bc_matrices/mm10")
...
sample_1 <- "pLN"
sample_2 <- "Tx_pLN"
Output_PATH <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/pLN_TxpLN"
setwd("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/pLN_TxpLN")
...
FeaturePlot(LN_minus, features.plot = c("Cxcl9","Madcam1","Il7",
                                        "Icam1","Cxcl13","Ccl19",
                                        "Cd248","Cd34","Acta2"),
            no.legend = TRUE,
...
saveRDS(LN_minus,paste(getwd(),"/",sample_1,"_",sample_2, ".Rds",sep=""))
LN_minus <- readRDS(paste(getwd(),"/",sample_1,"_",sample_2, ".Rds",sep=""))
...
mLN_main <- read.delim("/home/pezoldt/NAS2/pezoldt/Data/scRNAseq/2018_NC_stroma/Exp_195_Tx_imprinted_signature/mLN_maintained.txt")
...
mLN_rep <- read.delim("/home/pezoldt/NAS2/pezoldt/Data/scRNAseq/2018_NC_stroma/Exp_195_Tx_imprinted_signature/mLN_maintained.txt")
