...
#significant DMRs
DMR_sig_SPF_mLN_pLN <- subset(DMR_SPF_mLN_pLN, n >= 3 & (meanDiff >= 0.20 | meanDiff <= -0.20) &
...
mLN_DMR_DEG_UP <- subset(merge_DMR_DEG, mean_dMeth_gene <= -0.2 & SPF_mLN_pLN_log2FoldChange <= -1)
mLN_DMR_DEG_DOWN <- subset(merge_DMR_DEG, mean_dMeth_gene >= 0.2 & SPF_mLN_pLN_log2FoldChange >= 1)
mLN_DMR_DEG_DOWN_demeth <- subset(merge_DMR_DEG, mean_dMeth_gene >= 0.2 & SPF_mLN_pLN_log2FoldChange <= -1)
#Methylation status and corresponding expression
mLN_DMR_DEG_lineup <- rbind(mLN_DMR_DEG_UP, mLN_DMR_DEG_DOWN)
...
DARs_features_TSS <- subset(DARs_features_Genes, distancetoFeature <= 200)
DARs_features_TSS <- subset(DARs_features_TSS, distancetoFeature >= -10000)
...
mLN_DMR_DAR_UP <- subset(DARs_DMRs_TSS, mean_dMeth_gene <= -0.2 & log2FC_SPF_mLN_pLN >= 1.0)
Nkx23 <- subset(DARs_DMRs_TSS, symbol == "Nkx2-3")
mLN_DMR_DAR_DOWN <- subset(DARs_DMRs_TSS, mean_dMeth_gene >= 0.2 & log2FC_SPF_mLN_pLN <= -1.0)
# Note: Rather interesting TFs Demeth but firmly closed
mLN_DMR_DAR_DOWN_OFF <- subset(DARs_DMRs_TSS, mean_dMeth_gene <= -0.2 & log2FC_SPF_mLN_pLN <= -1.0)
#Methylation status and corresponding expression
mLN_DMR_DAR_lineup <- rbind(mLN_DMR_DAR_UP, mLN_DMR_DAR_DOWN)
