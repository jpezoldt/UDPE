...
#mLN D0
###
sample_1.data <- Read10X(data.dir = "~/NAS2/pezoldt/Data/scRNAseq/270_2018-01-03_scRNA-Seq_mLN_ontogeny/Data/C11_neo_mLN/outs/filtered_gene_bc_matrices/mm10")
sample_1.data@Dimnames[[2]] <- paste("sample_d0_", c(1:length(sample_1_2.data@Dimnames[[2]])), sep = "")

#######
#Global variables
#######
sample_1 <- "mLN"
setwd("~/NAS2/pezoldt/Analysis/scRNAseq/seurat/D0_Signature_Clusters")
