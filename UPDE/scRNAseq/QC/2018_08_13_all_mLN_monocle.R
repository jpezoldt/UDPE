...
#Global variable
#####
datasets <- c("mLN_SPF_1","mLN_SPF_2","mLN_GF")
...
#####
#mLN SPF 1
dir_mLN_SPF_1 <- "R:/pezoldt/Data/scRNAseq/244_scRNA-Seq_mLN_pLN_SPF/Data/10X_results/L1700567_mLN_SPF"
mLN_SPF_1 <- load_cellranger_matrix(dir_mLN_SPF_1, genome = "mm10")
#mLN SPF 2
dir_mLN_SPF_2 <- "R:/pezoldt/Data/scRNAseq/252_2017-07-19_scRNA-Seq_mLN_pLN_SPF_GF/Data/10x/mLN_SPF/B6"
mLN_SPF_2 <- load_cellranger_matrix(dir_mLN_SPF_2, genome = "mm10")

#mLN GF
dir_mLN_GF_1 <- "R:/pezoldt/Data/scRNAseq/269_2018-04-23_scRNA-Seq_mLN_GF/Data/E6_GF_mLN"
mLN_GF_1<- load_cellranger_matrix(dir_mLN_GF_1, genome = "mm10")
#list datasets
l_GBCMs <- list(mLN_SPF_1,mLN_SPF_2,mLN_GF_1)
...
upper_bound <- 250
lower_bound <- 5000
qplot(Total_mRNAs, data = pData(cde_all), color = Time_point, geom = "density") +
