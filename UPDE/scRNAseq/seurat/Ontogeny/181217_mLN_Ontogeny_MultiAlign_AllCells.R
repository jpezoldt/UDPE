...
# Visualize across states
#RidgePlot(object = obs.mLN_Ontogeny_minus_main.merged, features.plot = c("Pcna", "Top2a", "Mcm6", "Mki67"), 
#         nCol = 2)
...
p1 <- TSNEPlot(obs.mLN_Ontogeny_minus_main.merged, group.by = "tech", do.return = T, pt.size = 0.4, cells.use = sample_1_cells)
...
#####
#Obtain cell IDs for MAIN
#####
#Define clusters to be excluded
#Write Metadata
saveRDS(obs.mLN_Ontogeny_minus_main.merged@meta.data, paste(PATH_Output,"/","MetaData_1500_1000_1_12_SC_minus_feeder1_2_3_PvC.Rds", sep=""))
