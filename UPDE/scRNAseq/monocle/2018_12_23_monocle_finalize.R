...
num_cells_exp <- 20
#Import PATH
seurat_dataset <- "_1500_1000_1_12_SC_minus_feeder1_3_PvC.Rds"
PATH_input_seurat <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/seurat/Ontogney_Multialign/D0_to_D300"
#Export PATH
PATH_output <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/monocle/day0_10_24_56_300/Seurat_selected"
PATH_CDS_objects <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/monocle/day0_10_24_56_300/Seurat_selected/CDS_objects"
#Signatures from mLN
...
#sample_4_2_seurat <- CreateSeuratObject(raw.data = sample_4_2.data, min.cells = num_cells_exp, min.genes = 1000)
#Merge as seurat
#sample_4_seurat <- MergeSeurat(sample_4_1_seurat, sample_4_2_seurat, do.normalize = FALSE)
# column bind the two expression matrices
#Make SCE
#annotation_d56 <- data.frame(cell_type1=sample_4_seurat@ident, row.names = rownames(sample_4_seurat@meta.data))
#readcount file with only the cells within the annotation file
#count_matrix <- as.matrix(sample_4_seurat@raw.data)
#count_matrix_d56 <- count_matrix[,rownames(annotation_d56)]
#d56 <- SingleCellExperiment(assays = list(counts = as.matrix(count_matrix_d56)), colData = annotation_d56)
#Convert to CDS
#d56 <- convertTo(d56, type="monocle")
...
cde_SC <- reduceDimension(cde_SC, max_components = 2, num_dim = 20,
                              ...
                              verbose = T)
cde_SC <- clusterCells(cde_SC, num_clusters = 15)
pData_LTO <- subset(pData(cde_SC), Cluster == 9)
pData_CD34Cdk1 <- subset(pData(cde_SC), Cluster_Seurat == "CD34+Cdk1+")
plot_cell_clusters(cde_SC, 1, 2, color = "Cluster", show_cell_names = TRUE, cell_name_size = 10)
...
plot_cell_trajectory(cde_SC, color_by = "State") + facet_wrap(~Cluster_Seurat)
...
#Save RDS
saveRDS(cde_SC, file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_2_PvC.Rds",sep=""))
cde_SC <- readRDS(file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_2_PvC.Rds",sep=""))


#########
#Building trajectories nonPvC------------------------------
#########
#cde_nonPvC <- reduceDimension(cde_nonPvC, max_components = 2, num_dim = 12,
 #                             reduction_method = 'tSNE',
  #                            residualModelFormulaStr = "~Total_mRNAs + mito_expression + ribo_expression + Time_point",
   #                           verbose = T)
...
#Check_datasets
#####
#From: Seurat selected/CDS_objects
#Note:
# - separates two distinct developemnt spaces with only 143 cells linking them
day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include_minus_feeder2 <- 
  readRDS("/Users/Pezoldt/Desktop/R_christmas/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include_minus_feeder2.Rds")

#Note:
# - separates two distinct developemnt spaces with only 110 cells linking them
# - most solid secgregation 
day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include_no_PvC <-
  readRDS("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/monocle/day0_10_24_56_300/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include_no_PvC.Rds")

#Note:
# - separates two distinct developemnt spaces with only 261 cells linking them
day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include <-
  readRDS("/Users/Pezoldt/Desktop/R_christmas/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include.Rds")

#Note:
# - separates two distinct developemnt spaces with only 60 cells linking them
# - Perycytes open prebranch of nonadventitial cells which is currently not supported by literature
day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_all_but_SCx <-
  readRDS("/Users/Pezoldt/Desktop/R_christmas/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_all_but_SCx.Rds")

#Note:
# - triangular with PvC squeezed in nonAdv trajectory
day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_all <-
  readRDS("/Users/Pezoldt/Desktop/R_christmas/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_all.Rds")

#Note:
# - separates two distinct developemnt spaces with only 238 cells linking them
day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_minus_feeder2 <-
  readRDS("/Users/Pezoldt/Desktop/R_christmas/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_minus_feeder2.Rds")

#Note:
# - separates two distinct developemnt spaces with only 110 cells linking them
day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_no_PvC <-
  readRDS("/Users/Pezoldt/Desktop/R_christmas/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include_no_PvC.Rds")

#Note:
# - separates two distinct developemnt spaces with only 378 cells linking them
day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include <-
  readRDS("/Users/Pezoldt/Desktop/R_christmas/Seurat_selected/CDS_objects/day0_10_24_56_300_Seurat_SC_1500_1000_1_12_cells_include.Rds")

#Note:
# - separates two distinct developemnt spaces with only 210 cells linking them -> annotated to NonAdventi
day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_3_PvC <-
  readRDS("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/monocle/day0_10_24_56_300/Seurat_selected/CDS_object/day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_2_PvC.Rds")

#cde_x <- cde_SC

#plot_cell_trajectory(cde_x, color_by = "State")
#plot_cell_trajectory(cde_x, color_by = "State") + facet_wrap(~Time_point)
#plot_cell_trajectory(cde_x, color_by = "State", markers = c("Cdk1","Cd34","Cxcl13","Vcam1","Tnfsf11","Acta2"), use_color_gradient = TRUE)
#nrow(subset(pData(cde_x)))
...
#plot_cell_trajectory(cde_nonPvC, markers = c("Cdk1"), use_color_gradient = TRUE) + facet_wrap(~Time_point)
...
#Save RDS
#saveRDS(cde_nonPvC, file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include.Rds",sep=""))
#cde_nonPvC <- readRDS(file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_nonPvC_1500_1000_1_12_cells_include.Rds",sep=""))
...
plot_cell_trajectory(cde_NonAdv, color_by = "Pseudotime")
...
plot_cell_trajectory(cde_NonAdv, color_by = "State", markers = c("Cdk1","Inmt","Cxcl13","Cxcl1","Tnfsf11","Il6"), use_color_gradient = TRUE)
plot_cell_trajectory(cde_NonAdv, markers = c("Cdk1","Aldh1a2","Cxcl13","Cd34","Acta2"), use_color_gradient = TRUE, cell_size = 0.5)
plot_cell_trajectory(cde_NonAdv, markers = c("Bst1","Pdpn","Pdgfrb","Cd34"), use_color_gradient = TRUE, cell_size = 0.5)
...
#Save RDS
saveRDS(cde_NonAdv, file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_3_PvC_only_NonAdventi_.Rds",sep=""))
...
plot_cell_trajectory(cde_Adv, color_by = "Pseudotime")
#cde_NonAdv root state
cde_Adv <- orderCells(cde_Adv, root_state = 4)
plot_cell_trajectory(cde_Adv, color_by = "State")
plot_cell_trajectory(cde_Adv, color_by = "State") + facet_wrap(~Time_point)
plot_cell_trajectory(cde_Adv, color_by = "State", markers = c("Cdk1","Ptgis","Aldh1a2","Cd248","Fltl3","Col4a1"), use_color_gradient = TRUE)
plot_cell_trajectory(cde_Adv, markers = c("Cdk1","Aldh1a2","Cxcl13","Cd34","Acta2"), use_color_gradient = TRUE, cell_size = 0.5)
...
#Save RDS
saveRDS(cde_Adv, file=paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_3_PvC_only_Adventi_.Rds",sep=""))

#Load RDS
cde_NonAdv <- readRDS(paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_3_PvC_only_NonAdventi_.Rds",sep=""))
cde_Adv <- readRDS(paste(PATH_CDS_objects,"/day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_3_PvC_only_Adventi_.Rds",sep=""))
...
saveRDS(l_BEAM_res, paste(PATH_output,"/","BEAM_day0_10_24_56_300_Seurat_1500_1000_1_12_SC_minus_feeder1_3_PvC_only_Adventi.rds",sep=""))
