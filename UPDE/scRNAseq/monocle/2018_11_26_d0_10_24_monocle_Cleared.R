...
#Global variable
#####
condition = "day0_10_24"
datasets <- c("d000","d010","d024")
#,"d056","d300")
#Number of cells in which a gene should be expressed to be included in analysis
num_cells_exp <- 25
#Export PATH
PATH_output <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/monocle/day0_10_24_56_300/Cleared/d0_d10_d24"
PATH_CDS_objects <- "/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/monocle/day0_10_24_56_300/Cleared/d0_d10_d24/CDS_objects"
#Signatures from mLN
...
#Save RDS
saveRDS(cde_SC, file=paste(PATH_CDS_objects,"/day0_10_24_56_300_SC_withCluster4.Rds",sep=""))
...
cde_nonPvC <- reduceDimension(cde_nonPvC, max_components = 2, num_dim = 10,
                              ...
                              residualModelFormulaStr = "~Total_mRNAs + mito_expression + ribo_expression + Time_point",
                              verbose = T)
cde_nonPvC <- clusterCells(cde_nonPvC, num_clusters = 16)
plot_cell_clusters(cde_nonPvC, 1, 2, color = "Cluster", show_cell_names = TRUE, cell_name_size = 10)
...
#Set root state
cde_nonPvC <- orderCells(cde_nonPvC, root_state = 4)
...
plot_cell_trajectory(cde_nonPvC, color_by = "State", markers = c("Il6"), use_color_gradient = TRUE)  + facet_wrap(~Time_point)
