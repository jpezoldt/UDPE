...
# mLN non-adventitial cells
nonadventi_cells <- rownames(subset(annotation_mLN, cell_type1 %in% c("Ccl19highMadcam1+","Inmt+Cxcl12+",
                                                                   "Inmt+","Il6+Cxcl1","Ccl19+Il7+"))) 
annotation_mLN_nonadventi <- subset(annotation_mLN, cell_type1 %in% c("Ccl19highMadcam1+","Inmt+Cxcl12+",
                                                                   "Inmt+","Il6+Cxcl1","Ccl19+Il7+"))
count_matrix_nonadventi <- count_matrix_mLN[,nonadventi_cells]
mLN_nonadventi_sce <- SingleCellExperiment(assays = list(counts = as.matrix(count_matrix_nonadventi)), colData = annotation_mLN_nonadventi)
...
Adventi_clusters <- c("Cd34+Gdf10+",
                     ...
                     "Cd34+Cd248+")
nonAdventi_clusters <- c("Ccl19highMadcam1+","Inmt+Cxcl12+",
                         "Inmt+","Il6+Cxcl1","Ccl19+Il7+")
...
expr_nonAdventi <- readRDS(paste("/home/pezoldt/NAS2/pezoldt/Analysis/scRNAseq/scenic/mLN_SPF/nonAdventi/int/exprMat_nonAdventi.Rds", sep=""))
...
myDatasetTitle="mLN-SPF non-Endothelial SC nonAdventi"
...
DT::datatable(regulonTargetsInfo[TF==c("Atf3","Jun","Jund","Elk4") & highConfAnnot==TRUE, colsToShow, with=F], escape=FALSE, filter="top")
